...
def main():
    ...
    #数据集的路径
    data_dir = "/Users/precious/defect_detecting/data/intel/train/"
    tra_image_dir = "/Users/precious/defect_detecting/data/intel/train/"
    tra_label_dir = "/Users/precious/defect_detecting/data/intel_target/"
    ...
    for img_path in tra_img_name_list:
        ...
        tra_label_name_list.append(tra_label_dir + imidx + label_ext)
    ...
    if torch.cuda.is_available():
        ...
        print("CUDA")
    #加载预训练权重
    model_dir = './WaterWatch/saved_models/' + model_name + '/' + "u2netp.pth"
    ...
    ite_num4val = 0
    #save_frq改成自己的数据集总数
    save_frq = 150 # save the model every 174 iterations
    ...
    for epoch in range(0, epoch_num):
        ...
        save_image(d0,"/Users/precious/defect_detecting/data/intel/train_img/{}.png".format(epoch),nrow=4)
